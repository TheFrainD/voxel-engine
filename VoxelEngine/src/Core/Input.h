...
namespace Voxel
{
	...
	{
		bool grabbed;
		bool buttons[MouseButton::Last + 1];

		glm::vec2 position;
		glm::vec2 lastPosition;
		MouseButtonCode lastButton;
	};
	...
	public:
		...
		static glm::vec2 GetMouseLastPosition();
	...
	private:
		...
		friend void ::mouse_callback(GLFWwindow* window, int button, int action, int mode);
